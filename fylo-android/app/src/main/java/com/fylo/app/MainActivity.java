...
public class MainActivity extends AppCompatActivity {
    ...
    // True each session — triggers SW eviction on first page load every launch
    ...
    private void setupWebView() {
        ...
        mWebView.setWebViewClient(new WebViewClientCompat() {
            ...
            // When the renderer crashes the last frame freezes on screen and ALL
            // JavaScript (including setTimeout failsafes) dies with it. The user
            // sees a permanently frozen splash and must force-close the app.
            // Fix: recreate() restarts the Activity with a fresh WebView.
            // Crash counter stops infinite loops (max 3 retries).
            @Override
